...
assert(not keyring.fields.utils.shared.is_shared_with("singleplayer",
	"totosingleplayer"))
assert(keyring.fields.utils.shared.is_shared_with("singleplayer",
...
assert(keyring.fields.utils.shared.remove("singleplayer",
	"singleplayer tata toto") == "tata toto")
assert(keyring.fields.utils.shared.remove("singleplayer",
	"tata toto singleplayer") == "tata toto")
assert(keyring.fields.utils.shared.remove("singleplayer",
	"tata singleplayer toto") == "tata toto")
...
assert(keyring.fields.utils.shared.get_from_index(1,
	"singleplayer toto tata") == "singleplayer")
assert(keyring.fields.utils.shared.get_from_index(2,
	"tata singleplayer toto") == "singleplayer")
assert(keyring.fields.utils.shared.get_from_index(3,
	"tata toto singleplayer") == "singleplayer")
